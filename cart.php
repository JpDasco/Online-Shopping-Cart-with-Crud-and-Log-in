                                ...
                                <?php if(isset($_SESSION['cartItems'])): ?>
                                    <?php foreach($_SESSION['cartItems'] as $key => $value): ?>
                                        <?php foreach($value as $size => $quantity): ?>
                                            ...
                                            <tr>                                        
                                                <td><img src="images/<?php echo $arrProducts[$key]['photo1']; ?>" class="img-thumbnail" style="height: 80px;"></td>
                                                ...
                                                <td><a href="remove_confirm.php?<?php echo 'delkey=' . $key . '&c=' . $size . '&q=' . $quantity; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endforeach; ?>
