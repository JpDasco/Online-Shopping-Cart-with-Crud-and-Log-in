...
<html lang="en">
    <head>
        ...
        <title>Remove Confirm | Online Sneaker</title>
    </head>
    <body>
        <form method="post">
            <div class="container">
                        ...
                        <div class="col-md-3 col-sm-6 mb-4">
                            <div class="product-grid2 card">
                                <div class="product-image2">
                                    <a href="">
                                        <img class="pic-1" src="images/<?php echo $arrProducts[$_GET['delkey']]['photo1']; ?>">
                                        <img class="pic-2" src="images/<?php echo $arrProducts[$_GET['delkey']]['photo2']; ?>">
                                    </a>                            
                                </div>                        
                            </div>
                        </div>                
